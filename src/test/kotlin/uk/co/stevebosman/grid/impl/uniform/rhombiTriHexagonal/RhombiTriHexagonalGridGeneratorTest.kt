...
class RhombiTriHexagonalGridGeneratorTest {
    ...
    fun testStandardGenerated1by1grid() {
        ...
        assertEquals(1, grid.cells.keys.filter { r -> RhombiTriHexagonalCellType.of(r)== RhombiTriHexagonalCellType.Hexagon }.size)
    }
    ...
    fun testStandardGenerated2by2grid() {
        ...
        assertEquals(4, grid.cells.keys.filter { r -> RhombiTriHexagonalCellType.of(r)== RhombiTriHexagonalCellType.Hexagon }.size)
    }
    ...
    fun testStandardSkipLastGenerated2by2grid() {
        ...
        assertEquals(3, grid.cells.keys.filter { r -> RhombiTriHexagonalCellType.of(r)== RhombiTriHexagonalCellType.Hexagon }.size)
    }
    ...
    fun testTriangleGenerated3by3grid() {
        ...
        assertEquals(6, grid.cells.keys.filter { r -> RhombiTriHexagonalCellType.of(r)== RhombiTriHexagonalCellType.Hexagon }.size)
    }
